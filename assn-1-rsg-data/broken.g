This is a grammar with a non-terminal that is used but never defined.
Use this grammar to test whether your program notices that error 
condition reasonably.  It's a just the Bond grammar with some definitions
removed.
